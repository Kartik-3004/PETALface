...
class IJBSTest:
    ...
    def init_proto(self, folder_ijbs_protocols):
        ...
        filename = os.path.join(folder_ijbs_protocols, 'ijbs_metadata.csv')
        ...
        filename = os.path.join(folder_ijbs_protocols, 
            'galleries/ijbs_surveillance_to_surveillance_g1.csv')
        with open(filename, 'r') as f:
            lines = f.readlines()
            lines = lines[1:]
        ...
        filename = os.path.join(folder_ijbs_protocols, 
            'galleries/ijbs_surveillance_to_surveillance_g2.csv')
        with open(filename, 'r') as f:
            lines = f.readlines()
            lines = lines[1:]
        video_list = [(x.split(',')[1], x.split(',')[2]) for x in lines]
        ...
        filename = os.path.join(folder_ijbs_protocols,
            'ijbs_surveillance_to_single-booking_probe.csv')
        with open(filename, 'r') as f:
            lines = f.readlines()
            lines = lines[1:]
        video_list = [x.split('\n')[0] for x in lines]
        ...
        filename = os.path.join(folder_ijbs_protocols,
            'ijbs_surveillance_to_surveillance_probe.csv')
        with open(filename, 'r') as f:
            lines = f.readlines()
            lines = lines[1:]
        ...
        filename = os.path.join(folder_ijbs_protocols,
            'ijbs_uav_to_single-booking_probe.csv')
        with open(filename, 'r') as f:
            lines = f.readlines()
            lines = lines[1:]
        uav_list = [x.split('\n')[0] for x in lines]
        ...
        filename = os.path.join(folder_ijbs_protocols, 
            'galleries/ijbs_surveillance_to_single_g1.csv')
        with open(filename, 'r') as f:
            lines = f.readlines()
            lines = lines[1:]
        ...
        filename = os.path.join(folder_ijbs_protocols, 
            'galleries/ijbs_surveillance_to_single_g2.csv')
        with open(filename, 'r') as f:
            lines = f.readlines()
            lines = lines[1:]
        image_list = [(x.split(',')[1], x.split(',')[2]) for x in lines]
        ...
        filename = os.path.join(folder_ijbs_protocols,
            'galleries/ijbs_surveillance_to_booking_g1.csv')
        with open(filename, 'r') as f:
            lines = f.readlines()
            lines = lines[1:]
        ...
        filename = os.path.join(folder_ijbs_protocols,
            'galleries/ijbs_surveillance_to_booking_g2.csv')
        with open(filename, 'r') as f:
            lines = f.readlines()
            lines = lines[1:]
        subject_list = [int(x.split(',')[1]) for x in lines]
